...
struct ScheduleConfig {
    ...
    // struct {                     // amba compiler do not support anonymous struct
        int numThread = 4;
        int gpuMode = 4;
    // };
#if defined(AMBA_H22)
    bool core_available[AMBA_H22_NR_AVAILABLE_CORES] = {false, true, true, false};
    int priority[AMBA_H22_NR_AVAILABLE_CORES] = {5, 5, 5, 5};
#endif
...
public:
    ...
    ErrorCode runSessionProfiler(Session* session, int run_times) const;
